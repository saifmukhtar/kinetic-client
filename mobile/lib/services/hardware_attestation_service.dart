...
class HardwareAttestationService {
  static const MethodChannel _channel = MethodChannel('dev.saifmukhtar.kinetic/attestation');
  ...
  static Future<TrustTier> verifyDevice() async {
    if (kDebugMode || Platform.isLinux || Platform.isWindows || Platform.isMacOS) {
