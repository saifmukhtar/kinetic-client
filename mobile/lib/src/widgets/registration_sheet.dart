          ...
          children: [
            ...
            if (isIdle || isError) ...[
              TextField(
                ...
                onChanged: (val) =>
                    ref.read(registrationProvider.notifier).setDesktopUrl(val),
              ),
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    ref
                        ...
                        .startRegistration(widget.name);
                  },
                  child: const Text(
                    'Start Cryptographic Registration',
                    style: TextStyle(
                      color: Colors.white,
              ...
              _buildProgressItem(
                ...
                isActive:
                    regState.status == RegistrationStatus.attesting ||
                    (isError &&
                        regState.failedStep == RegistrationStatus.attesting),
                isDone:
                    regState.status.index >
                        RegistrationStatus.attesting.index &&
                    !(isError &&
                        regState.failedStep == RegistrationStatus.attesting),
                isError:
                    isError &&
              ...
              _buildProgressItem(
                ...
                isActive:
                    regState.status == RegistrationStatus.requestingVdf ||
                    (isError &&
                        regState.failedStep ==
                            RegistrationStatus.requestingVdf),
                isDone:
                    regState.status.index >
                        RegistrationStatus.requestingVdf.index &&
                    !(isError &&
                        regState.failedStep ==
                            RegistrationStatus.requestingVdf),
                isError:
                    isError &&
                    regState.failedStep == RegistrationStatus.requestingVdf,
                errorText:
                    (isError &&
                        regState.failedStep == RegistrationStatus.requestingVdf)
                    ? regState.error?.message
              ...
              _buildProgressItem(
                ...
                isActive:
                    regState.status == RegistrationStatus.pollingVdf ||
                    (isError &&
                        regState.failedStep == RegistrationStatus.pollingVdf),
                isDone:
                    regState.status.index >
                        RegistrationStatus.pollingVdf.index &&
                    !(isError &&
                        regState.failedStep == RegistrationStatus.pollingVdf),
                isError:
                    isError &&
              ...
              _buildProgressItem(
                ...
                isActive:
                    regState.status == RegistrationStatus.broadcasting ||
                    (isError &&
                        regState.failedStep == RegistrationStatus.broadcasting),
                isDone:
                    regState.status.index >
                        RegistrationStatus.broadcasting.index &&
                    !(isError &&
                        regState.failedStep == RegistrationStatus.broadcasting),
                isError:
                    isError &&
